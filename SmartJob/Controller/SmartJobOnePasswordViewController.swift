//
//  SmartJobOnePasswordViewController.swift
//  SmartJob
//
...
class SmartJobOnePasswordViewController: UIViewController , UITextFieldDelegate {
    ...
    @IBOutlet weak var oneAccountView: UIView!
    ...
    func doChangePassword(usercode : String , password : String , birthDate : String) -> NSDictionary {
        ...
        let employeeProfile = doGetEmployeeDetail(employeeId: employee.object(forKey: "EmployeeID") as! String)
    ...
    @IBAction func doLogout(_ sender: Any) {
        ...
        performSegue(withIdentifier: "SmartJobCancelLoginSegue", sender: self)
