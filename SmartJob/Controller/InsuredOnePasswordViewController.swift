//
//  InsuredOnePasswordViewController.swift
//  SmartJob
//
...
class InsuredOnePasswordViewController: UIViewController , UITextFieldDelegate{
        ...
        if passwordLb.text == confirmPasswordLb.text {
            ...
            if respStatus.object(forKey: "StatusID") as! Int == 1 {
                ...
                alertController.addAction(UIAlertAction(title: "ตกลง", style: UIAlertActionStyle.default,handler: {
                    (action:UIAlertAction!) in self.doCheckRegisterFlag()
                }
                ))
    ...
    func doCheckRegisterFlag () {
    
        if employee.object(forKey: "RegisterFlag") as! String == "1" {
        
            performSegue(withIdentifier: "InsuredOnePasswordCompleteSegue", sender: self)
    ...
    @IBAction func doLogout(_ sender: Any) {
        ...
        performSegue(withIdentifier: "InsuredCancelLoginSegue", sender: self)
