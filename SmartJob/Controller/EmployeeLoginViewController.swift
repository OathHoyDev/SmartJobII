...
class EmployeeLoginViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        userCodeTx.resignFirstResponder()
...
//        NotificationCenter.default.addObserver(self, selector: #selector(EmployeeLoginViewController.keyboardWillShow(_:)), name: NSNotification.Name.UIKeyboardWillShow, object: nil)
    ...
    override func viewDidLoad() {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(EmployeeLoginViewController.tap(_:)))
    ...
    func login() {
        ...
        Thread.detachNewThreadSelector(#selector(EmployeeLoginViewController.startIndicator), toTarget: self, with: nil)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "EmployeeRegisterSegue" {
            ...
            //let viewController:EmployeeDetailViewController = segue.destinationViewController as! EmployeeDetailViewController
            
            //viewController.employee = employeeDetail
    ...
    func applyJob(){
        ...
        do {
            ...
            if respStatus["StatusID"] as! NSNumber == 1 {
                ...
                alertController.addAction(UIAlertAction(title: "ตกลง", style: UIAlertActionStyle.default,handler: {
                    (action) -> Void in
                    self.performSegue(withIdentifier: "ApplyJobCompleteSegue", sender: self)
                }))
